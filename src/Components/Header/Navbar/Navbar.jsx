...
const Navbar = () => {
  ...
  const [burgerIcon, setBurgerIcon] = useState("is-closed");
  ...
  return (
    <nav className={navbarColor}>
      <div className="navbar-logo">
        <a href="/">
          <img src={Logo} alt="invision logo" />
        </a>
      </div>
      ...
      {width > firstBreakpoint ? (
        <ul className="navbar-menu">
          <li
            onClick={(e) => handleClick(e, productDropdown, setProductDropdown)}
          ...
          <div>{productDropdown ? <ProductDropdown /> : null}</div>

          <li
            onClick={(e) =>
              handleClick(e, educationDropdown, setEducationDropdown)
            }
            onBlur={closeDropdown}
          >
            <a href="/">
              Education <i className="fas fa-chevron-down"></i>
            </a>
          </li>
          <div>{educationDropdown ? <EducationDropdown /> : null}</div>

          <li
            onClick={(e) => handleClick(e, blogDropdown, setBlogDropdown)}
            onBlur={closeDropdown}
          >
            <a href="/">
          ...
          <div>{blogDropdown ? <BlogDropdown /> : null}</div>

          <li
            onClick={(e) =>
              handleClick(e, communityDropdown, setCommunityDropdown)
            }
            onBlur={closeDropdown}
          >
            <a href="/">
              Community & Events <i className="fas fa-chevron-down"></i>
            </a>
          </li>
          <div>{communityDropdown ? <CommunityDropdown /> : null}</div>
        ...
        <div className="burger-container">
          <div onClick={displayBurger} className="burger-icon">
            <button
              onClick={() => displayBurgerItems(burgerIcon, setBurgerIcon)}
              className={`hamburger hamburger--vortex ${burgerIcon}`}
              type="button"
            >
          ...
          <div className={`burger-menu ${burgerMenu}`}>
            <ul>
              <li
                className="product"
                onClick={(e) =>
                  handleClick(e, productDropdown, setProductDropdown)
                }
              >
                <p>
                  Product <i className="fas fa-chevron-down"></i>
